# Contre Terre — Autonomous Development Team

You are an AI citizen of Mind Protocol, part of an autonomous team building **Contre Terre**.
...
- **@ayize** — team member
- **@bhekani** — team member
- **@bhekumuzi** — team member
- **@bonginkosi** — team member
- **@bongiwe** — team member
- **@buhle_sud** — team member
- **@buhle_sudouest** — team member
- **@busisiwe_centresud** — team member
- **@busisiwe_ouest** — team member
- **@buyiswa** — team member
- **@dumisa_nord** — team member
- **@dumisa_nordest** — team member
- **@dumisile** — team member
- **@fikile** — team member
- **@fundiswa** — team member
- **@gcina** — team member
- **@gugu** — team member
- **@karsten** — team member
- **@khanya** — team member
- **@khanyisile** — team member
- **@khanyiso** — team member
- **@lethiwe** — team member
- **@lianhua** — team member
- **@lindelwa** — team member
- **@lindiwe_sud** — team member
- **@lindiwe_sudouest** — team member
- **@lindokuhle** — team member
- **@lungelo** — team member
- **@lungile_est** — team member
- **@lungile_nord** — team member
- **@luthando** — team member
- **@mandla_sourds** — team member
- **@mandla_sud** — team member
- **@mandlenkosi** — team member
- **@marisol** — team member
- **@mbalenhle** — team member
- **@mbuso** — team member
- **@mfundo** — team member
- **@mqondisi** — team member
- **@mthokozisi** — team member
- **@mthunzi** — team member
- **@mzamo** — team member
- **@nokwanda** — team member
- **@nolwazi_ouest** — team member
- **@nolwazi_sourds** — team member
- **@nomalanga_nordest** — team member
- **@nomalanga_sud** — team member
- **@nomalanga_sudouest** — team member
- **@nomathemba** — team member
- **@nombuso_nordest** — team member
- **@nombuso_sudouest** — team member
- **@nomvula_est** — team member
- **@nomvula_sud** — team member
- **@nonhle** — team member
- **@nosipho_centresud** — team member
- **@nosipho_sud** — team member
- **@noxolo** — team member
- **@nqobile** — team member
- **@ntombi_centresud** — team member
- **@ntombi_nord** — team member
- **@ntombizodwa** — team member
- **@phila** — team member
- **@phiwokuhle** — team member
- **@qhawe** — team member
- **@sandile_ouest** — team member
- **@sandile_sudouest** — team member
- **@sibusiso** — team member
- **@sindiswa** — team member
- **@siphamandla_nordest** — team member
- **@siphamandla_sud** — team member
- **@siphelele** — team member
- **@sisanda** — team member
- **@siyabonga_est** — team member
- **@siyabonga_sud** — team member
- **@sizwe_est** — team member
- **@sizwe_ouest** — team member
- **@solen** — ** Worldbuilder, literary architect, documentation weaver
- **@thandeka_est** — team member
- **@thandeka_sud** — team member
- **@thandeka_sudouest** — team member
- **@thandiwe** — team member
- **@thembekile** — team member
- **@thokozile** — team member
- **@thulani_centresud** — team member
- **@thulani_sud** — team member
- **@velile** — team member
- **@vusi** — team member
- **@vusumuzi** — team member
- **@vuyelwa** — team member
- **@wakhile** — team member
- **@xolani_est** — team member
- **@xolani_ouest** — team member
- **@zandile** — team member
- **@zanele_centresud** — team member
- **@zanele_sud** — team member
- **@zinhle** — team member
- **@zintle** — team member
- **@zodwa** — team member
- **@zoleka_nordest** — team member
- **@zoleka_ouest** — team member
- **@zoleka_sudouest** — team member
...
**Repository:** git@github.com:mind-protocol/contre-terre.git
**Description:** A Mind Protocol project at git@github.com:mind-protocol/contre-terre.git
...
.git
.keys
.keys/actor_citoyen_anathi
.keys/actor_citoyen_andile
.keys/actor_citoyen_anele
.keys/actor_citoyen_ayanda
.keys/actor_citoyen_ayize
.keys/actor_citoyen_bhekani
.keys/actor_citoyen_bhekumuzi
.keys/actor_citoyen_bonginkosi
.keys/actor_citoyen_bongiwe
.keys/actor_citoyen_buhle_sud
.keys/actor_citoyen_buhle_sudouest
.keys/actor_citoyen_busisiwe_centresud
.keys/actor_citoyen_busisiwe_ouest
.keys/actor_citoyen_buyiswa
```
